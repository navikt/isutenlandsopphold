...
class HenleggelseTest {
    ...
    fun `henleggelse uten begrunnelse kaster`() {
        assertFailsWith<IllegalArgumentException> {
            lagHenleggelse().copy(begrunnelse = "")
        }
    }
    ...
    @Test
    fun `nyopprettet henleggelse er ikke journalført`() {
    ...
    fun `journalfor på allerede journalført henleggelse kaster`() {
        val journalfort =
            lagHenleggelse().journalfor(JournalpostId("123"), OffsetDateTime.parse("2026-01-11T08:00:00Z"))
    ...
    @Test
    fun `nyopprettet henleggelse er ikke distribuert`() {
        val henleggelse = lagHenleggelse()
