...
/**
 * Request body sent to ispdfgen for å generere PDF-en for et behandlingsutfall (vedtak eller
 * henleggelse) om utenlandsopphold. Feltnavnene må matche malen (template) registrert for
 * denne appen i ispdfgen (`isutenlandsopphold/vedtak-*` og `isutenlandsopphold/henlegg`).
 *
