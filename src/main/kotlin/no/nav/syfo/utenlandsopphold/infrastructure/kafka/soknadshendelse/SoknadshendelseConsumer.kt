...
private val soknadAlleredeLagretCounter: Counter =
    Counter
        .builder("${METRICS_NS}_soknad_allerede_lagret_count")
        .description("Antall mottatte søknader fra Kafka som allerede var lagret og ble hoppet over")
