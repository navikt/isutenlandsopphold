 ...
 *
 * Mottakerlisten (receiver) er alle søknadene til innbyggeren, og brukes som datagrunnlag for opptellingene.
 ...
 */
fun List<Soknad>.opptellingerFor(soknad: Soknad): List<Opptelling> {
